...
from utils.methods.booking import create_booking_json, update_booking_json, delete_booking
...
@pytest.mark.schema
def test_update_booking_schema():
    ...
    update_resp = update_booking_json(booking_id, UPDATE_BOOKING_DATA, token)

    assert_schema_validation(update_resp, schema)
